...
# constants for PHT00, FV91 and R00 labels file
...
fv91 = dict(fname = '../../cocomac-tools/cocotools/coords/fv91regioncenters.txt',
            converters = {0:cleanstr, 1:cleanstr, 2:float, 3:float, 4:float},
            cols = range(5))

r00 = dict(fname = '../../cocomac-tools/cocotools/coords/r00regioncenters.csv',
            converters = {0:cleanstr, 1:cleanstr, 2:float, 3:float, 4:float},
            cols = range(5))
			
hybrid = dict(fname = '../../cocomac-tools/cocotools/coords/hybridregioncenters.csv',
            converters = {0:cleanstr, 1:cleanstr, 2:float, 3:float, 4:float},
            cols = range(5))			
